...
<h1 align="center" size="20"><font face="STKaiti">欢迎来到企业管理系统|个人信息</font></h1>
	...
	<div id="main" style="float: left;  position: absolute;left: 400px; top:150px;font-size:30px">
			...
			%>
					<table bgcolor=gray border=1 style="background:rgba(255,255, 255, 0);">
						<tr>
							<td><img src="11.jpg" height="200" width="200"/></td>
							<td>姓名</td>
							<td>邮箱</td>
							<td>电话</td>
							<td>邮编</td>
...
<div id="footer" style="position: absolute;left:0px; top:585px;">
		<div class="footer">
			<p color="black"><h2><small>&copy; 17211134130周铭琰|个人信息</small></h2></p>
		</div>
	</div>	
