...
<div class="left" id="LeftBox">
	...
	<div id="main" style="float: left;  position: absolute;left: 500px; top:200px;font-size:30px">
			
			<%				
				if(request.getAttribute("messages") != null){
					
			%>
					<table border="1"  cellspacing="0" cellpadding="0" solid="#F00">
						<tr>
							<td>id&nbsp&nbsp</td>
							<td>接收者&nbsp&nbsp</td>
							<td>内容&nbsp&nbsp</td>
							<td>发送者&nbsp&nbsp</td>
							<td>是否已读&nbsp&nbsp</td>
							<td>操作</td>
						</tr>
						<%
					...
					<a href="ListMessagesServlet?pagenow=${pagenow-1}">上一页</a>
					<a href="ListMessagesServlet?pagenow=${pagenow+1}">下一页</a>	
			<% 		
				}
	...
	<div class="left01">
		...
		<div class="left01_left"></div>
		<div class="left03_c"><a href="login.jsp">安全退出</div>
	</div>
</div>
	<div id="footer" style="position: absolute;left:0px; top:585px;">
		<div class="footer">
			<p color="black"><h2><small>&copy; 17211134130周铭琰|收件箱</small></h2></p>
		</div>
	</div>	
